...
export function Room802({ ...props }: JSX.IntrinsicElements["group"]) {
    ...
    useFrame((state) => {
        if (arcadeClick) {
            ...
            if (
                state.camera.quaternion.x.toFixed(1) ===
                    arcadeCameraQ.x.toFixed(1) &&
                state.camera.quaternion.y.toFixed(1) ===
                    arcadeCameraQ.y.toFixed(1) &&
                state.camera.quaternion.z.toFixed(1) ===
                    arcadeCameraQ.z.toFixed(1) &&
                state.camera.quaternion.w.toFixed(1) ===
                    arcadeCameraQ.w.toFixed(1)
            ) {
                setArcadeLink(true);
            }
        } else if (tvClick) {
            ...
            if (
                state.camera.quaternion.x.toFixed(1) ===
                    tvCameraQ.x.toFixed(1) &&
                state.camera.quaternion.y.toFixed(1) ===
                    tvCameraQ.y.toFixed(1) &&
                state.camera.quaternion.z.toFixed(1) ===
                    tvCameraQ.z.toFixed(1) &&
            ...
            if (
                state.camera.quaternion.x.toFixed(1) ===
                    posterCameraQ.x.toFixed(1) &&
                state.camera.quaternion.y.toFixed(1) ===
                    posterCameraQ.y.toFixed(1) &&
                state.camera.quaternion.z.toFixed(1) ===
                    posterCameraQ.z.toFixed(1) &&
                state.camera.quaternion.w.toFixed(1) ===
                    posterCameraQ.w.toFixed(1)
            ) {
                setPosterLink(true);
            }
        } else if (phoneClick) {
            ...
            if (
                state.camera.quaternion.x.toFixed(1) ===
                    phoneCameraQ.x.toFixed(1) &&
                state.camera.quaternion.y.toFixed(1) ===
                    phoneCameraQ.y.toFixed(1) &&
                state.camera.quaternion.z.toFixed(1) ===
                    phoneCameraQ.z.toFixed(1) &&
                state.camera.quaternion.w.toFixed(1) ===
                    phoneCameraQ.w.toFixed(1)
            ) {
                setPhoneLink(true);
            }
        } else {
